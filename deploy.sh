...
sudo /opt/google-cloud-sdk/bin/gcloud docker push eu.gcr.io/${PROJECT_NAME}/dfollereau-cppserver
...
sudo /opt/google-cloud-sdk/bin/gcloud docker run --detach --publish 8080:8080 --name mygccapp gcr.io/${PROJECT_NAME}/dfollereau-cppserver
ls -al
./client
