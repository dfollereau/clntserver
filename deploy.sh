...
sudo /opt/google-cloud-sdk/bin/gcloud docker login -e dfollereau@amadeus.com -u _token -p "$(/opt/google-cloud-sdk/bin/gcloud auth print-access-token)" https://gcr.io
